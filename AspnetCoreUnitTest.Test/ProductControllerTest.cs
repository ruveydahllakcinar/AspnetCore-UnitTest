using AspnetCoreUnitTestWeb.Controllers;
using AspnetCoreUnitTestWeb.Models;
using AspnetCoreUnitTestWeb.Repository;
...
namespace AspnetCoreUnitTest.Test
{
    ...
    public class ProductControllerTest
    {
        ...
        public ProductControllerTest()
        {
            ...
            products = new List<Product>() { new Product { Id=1, Name="Book2",Price=250, Stock=50, Color= "Pink" }, 
                new Product { Id = 2, Name = "Eraiser", Price = 50, Stock = 150, Color = "White" } };
        }
        [Fact]
